...
public class AutenticarController {
	...
	public ModelAndView autenticarPost(HttpServletRequest request) {
		...
		try {
			...
			String senha = EncryptHelper.encryptSHA1(request.getParameter("senha"));
	...
	/*
	 * Método para fazer o logout do usuário. Este método deverá capturar a rota
	 * /logout disparada pelo sistema.
	 */
