							...
							<div class="row">
								...
								<div class="col">
									<select id="ano" name="ano" class="form-select">
										<option value="2020" ${anoAtual == 2025 ? "selected" : ""}>2025</option>
										<option value="2021" ${anoAtual == 2026 ? "selected" : ""}>2026</option>
										<option value="2022" ${anoAtual == 2027 ? "selected" : ""}>2027</option>
										<option value="2023" ${anoAtual == 2028 ? "selected" : ""}>2028</option>
										<option value="2024" ${anoAtual == 2029 ? "selected" : ""}>2029</option>
										<option value="2025" ${anoAtual == 2030 ? "selected" : ""}>2030</option>
									</select>
								</div>
